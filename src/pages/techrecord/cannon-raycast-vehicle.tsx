...
const CannonRaycastVehicle = () => {
  // const { toggle } = useControls('Toggle Debug', { toggle: true });
  ...
  return (
    <Main
      meta={
        <Meta
          title="Raycast Vehicle Example"
          description="react-three/cannon Raycast Vehicle example."
        />
      }
    >
      <ThreeCanvas>
...
export default CannonRaycastVehicle;
